...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/complex_V0.css" />
...
//			size:				250
		...
		,	slidable:				true		// REFERENCE - cannot slide if spacing_closed = 0
		,	initClosed:				true
		//,	spacing_closed:			1			// wider space when closed
		//,	togglerLength_closed:	1			// make toggler 'square' - 21x21
...
<body onLoad="createInnerLayout(); return false;">
...
<div id="menu-north"  class="ui-layout-north" style="background-color:#444444;">


<?php include('menu_top_home.php'); ?>
...
<div id="mainContent">
	...
	<div class="ui-layout-center" style="padding-top:50px;">
